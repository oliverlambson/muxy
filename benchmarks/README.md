...
| ------------- | -------------- | -------------- | ------------- |
| **muxy**      | 175,824 (100%) | 0.52ms (100%)  | 0.71ms (100%) |
| **starlette** | 50,734 (29%)   | 1.88ms (362%)  | 2.35ms (331%) |
| **litestar**  | 52,712 (30%)   | 1.89ms (363%)  | 2.08ms (293%) |
| **sanic**     | 65,518 (37%)   | 1.53ms (294%)  | 1.74ms (245%) |
| **fastapi**   | 30,454 (17%)   | 3.00ms (577%)  | 3.93ms (554%) |
| **quart**     | 17,801 (10%)   | 5.63ms (1083%) | 6.57ms (925%) |
...
- muxy: 177,024, 175,824, 174,415
- starlette: 50,734, 50,629, 50,779
- litestar: 52,673, 52,712, 52,868
- sanic: 66,030, 65,518, 65,356
- fastapi: 30,454, 30,413, 30,500
- quart: 17,842, 17,801, 17,776
